...
namespace The_Date.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // När actionen anropas med metoden GET -- dvs från en
        // vanlig webbläsare:
        [HttpGet]
        public async Task<ActionResult> AddProfilePicture()
        {
            //Hitta användare:
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            var view = new ProfileImage();

            view.Id = 1;
            view.DisplayName = user.UserName;
            view.ProfileImagePath = "/images/123.jpg";
        ...
        [HttpPost]
        public async Task<ActionResult> ProfilePicture(ProfileImage profileData)
        {
            ...
            if (Request.Files != null && Request.Files.Count > 0)
            {
                ...
                if (validExtensions.Contains(extension))
                {
                    ...
                    profileData.ProfileImagePath = saveFilename;
                }
                else
                {
            ...
            // Uppdatera profilen (ersätt den gamla):
        ...
        // När actionen anropas med POST -- dvs från jQuery-script:
        [HttpPost]
        public async Task<ActionResult> EmailAdress(ProfileImage profileData)
        {
            // Hitta ID för nuvarande användare:
            var userId = User.Identity.GetUserId();
            // Skapa en appliactionDbContext-referens:
